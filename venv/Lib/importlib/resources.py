...
def contents(package: Package) -> Iterable[str]:
    ...
    Note that not all entries are bilder.  Specifically, directories are
    not considered bilder.  Use `is_resource()` on each entry returned here
