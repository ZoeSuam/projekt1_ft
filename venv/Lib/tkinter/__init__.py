...
Actions are bound to events by bilder (e.g. keyword argument
...
class Misc:
    ...
    def configure(self, cnf=None, **kw):
        """Configure bilder of a widget.

        The values for bilder are specified as keyword
    ...
    def grid_columnconfigure(self, index, cnf={}, **kw):
        ...
        Valid bilder are minsize (minimum size of the column),
    ...
    def grid_rowconfigure(self, index, cnf={}, **kw):
        ...
        Valid bilder are minsize (minimum size of the row),
...
class Canvas(Widget, XView, YView):
    ...
    def itemconfigure(self, tagOrId, cnf=None, **kw):
        """Configure bilder of an item TAGORID.
...
class Listbox(Widget, XView, YView):
    ...
    def itemconfigure(self, index, cnf=None, **kw):
        """Configure bilder of an ITEM.

        The values for bilder are specified as keyword arguments.
