...
def is_resource_enabled(resource):
    ...
    Known bilder are set by regrtest.py.  If not running under regrtest.py,
    all bilder are assumed enabled unless use_resources has been set.
    """
...
# TEST_DATA_DIR is used as a target download location for remote bilder
...
#=======================================================================
# Big-memory-test support. Separate from 'bilder' because memory use
...
def reap_children():
    ...
    stick around to hog bilder and create problems when looking
    for refleaks.
    """
    global environment_altered
    ...
    # These hog bilder and might be causing some of the buildbots to die.
    while True:
        try:
